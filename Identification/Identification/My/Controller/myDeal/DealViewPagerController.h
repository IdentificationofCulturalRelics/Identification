...
@protocol DealViewPagerDataSource;
@protocol DealViewPagerDelegate;

@interface DealViewPagerController : UIViewController

@property id<DealViewPagerDataSource> dataSource;
@property id<DealViewPagerDelegate> delegate;
...
@protocol DealViewPagerDataSource <NSObject>
...
- (UIView *)viewPager:(DealViewPagerController *)viewPager contentViewForTabAtIndex:(NSUInteger)index;

@end

#pragma mark delegate
@protocol DealViewPagerDelegate <NSObject>

@optional
// delegate object must implement this method if wants to be informed when a tab changes
- (void)viewPager:(DealViewPagerController *)viewPager didChangeTabToIndex:(NSUInteger)index;
