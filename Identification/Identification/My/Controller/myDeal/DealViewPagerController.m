...
#define kDefaultTabWidth KScreenWidth/3
...
// DealTabView for tabs, that provides un/selected state indicators
@class DealTabView;

@interface DealTabView : UIView
@property (nonatomic, getter = isSelected) BOOL selected;
@property (nonatomic) UIColor *indicatorColor;
@end

@implementation DealTabView
...
// DealViewPagerController
@interface DealViewPagerController () <UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate>
...
@implementation DealViewPagerController
...
- (IBAction)handleTapGesture:(id)sender {
    ...
    __weak DealViewPagerController *weakSelf = self;
...
- (DealTabView *)tabViewAtIndex:(NSUInteger)index {
    ...
    if ([[_tabs objectAtIndex:index] isEqual:[NSNull null]]) {
        ...
        // Create DealTabView and subview the content
        DealTabView *tabView = [[DealTabView alloc] initWithFrame:CGRectMake(0.0, 0.0, self.tabWidth, self.tabHeight)];
